...
public interface AgentDataFacade {
     ...
     * Same ID is used for both Java (DB primary key) and Python (downstream operations).
     *
     * @param agentId the UUID generated by Java and shared with Python
     */
    AgentDto createAgentWithId(UUID agentId,
